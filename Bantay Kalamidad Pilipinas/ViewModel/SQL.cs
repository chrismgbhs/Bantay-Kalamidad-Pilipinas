...
namespace Bantay_Kalamidad_Pilipinas.ViewModel
{
    internal class SQL
    {
        ...
        public static string connectionString = @"Data Source=CHREGION\SQLEXPRESS;Initial Catalog=""20260629 Bantay Kalamidad Pilipinas"";Integrated Security=True;Persist Security Info=False;Pooling=False;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=True;Application Name=""SQL Server Management Studio"";";
    }
}
