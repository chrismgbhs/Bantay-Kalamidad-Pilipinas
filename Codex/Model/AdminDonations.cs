        ...
        public string DonatedItemID
        {
            ...
            set
            {
                if (_donatedItemId != value)
                {
                    ...
                    OnPropertyChanged();
                    OnPropertyChanged(nameof(DonatedItemId)); // notify alias too
                }
            }
        }

        public string DonatedItemId => DonatedItemID;

        // EventId stores the actual Event_ID FK used in INSERT/UPDATE
        // Event stores the display name shown in the grid
